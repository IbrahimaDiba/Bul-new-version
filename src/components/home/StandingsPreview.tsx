          ...
          <table className="min-w-full bg-white">
            <thead>
              <tr className="bg-navy-900 text-white">
                ...
                <th className="hidden sm:table-cell py-2.5 sm:py-3 px-4 sm:px-6 text-center text-xs sm:text-sm whitespace-nowrap">Win %</th>
                <th className="hidden sm:table-cell py-2.5 sm:py-3 px-4 sm:px-6 text-center text-xs sm:text-sm whitespace-nowrap">Last 10</th>
                <th className="hidden sm:table-cell py-2.5 sm:py-3 px-4 sm:px-6 text-center text-xs sm:text-sm whitespace-nowrap">Streak</th>
              </tr>
            </thead>
            <tbody>
              {filteredTeams.map((team, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="hidden sm:table-cell py-3 sm:py-4 px-4 sm:px-6 text-center text-sm whitespace-nowrap">
                      {winPercentage.toFixed(3).substring(1)}
                    </td>
                    <td className="hidden sm:table-cell py-3 sm:py-4 px-4 sm:px-6 text-center text-sm whitespace-nowrap">{last10}</td>
                    <td className="hidden sm:table-cell py-3 sm:py-4 px-4 sm:px-6 text-center font-medium text-sm whitespace-nowrap">
