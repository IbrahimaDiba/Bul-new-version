            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-navy-900 text-white border-b-4 border-crimson-600">
                  ...
                  <th className="hidden sm:table-cell px-4 sm:px-4 py-3 sm:py-4 w-12 sm:w-20 text-center text-[9px] sm:text-[10px] font-black uppercase tracking-wider sm:tracking-widest whitespace-nowrap">Win %</th>
                  <th className="hidden sm:table-cell px-4 sm:px-4 py-3 sm:py-4 w-10 sm:w-16 text-center text-[9px] sm:text-[10px] font-black uppercase tracking-wider sm:tracking-widest whitespace-nowrap">GB</th>
                  <th className="hidden lg:table-cell px-4 py-4 w-20 text-center text-[10px] font-black uppercase tracking-widest whitespace-nowrap">Home</th>
                  <th className="hidden lg:table-cell px-4 py-4 w-20 text-center text-[10px] font-black uppercase tracking-widest whitespace-nowrap">Away</th>
                  <th className="hidden md:table-cell px-4 py-4 w-20 text-center text-[10px] font-black uppercase tracking-widest whitespace-nowrap">L10</th>
                  <th className="hidden md:table-cell px-4 py-4 w-20 text-center text-[10px] font-black uppercase tracking-widest whitespace-nowrap">Streak</th>
                </tr>
              </thead>
                ...
                {teamsWithStats.map((team, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="hidden sm:table-cell px-4 sm:px-4 py-3 sm:py-4 text-center whitespace-nowrap">
                      ...
                      <td className="hidden sm:table-cell px-4 sm:px-4 py-3 sm:py-4 text-center font-bold text-gray-500 tabular-nums text-[10px] sm:text-base whitespace-nowrap">
                        {team.gamesBehind === 0 ? '-' : team.gamesBehind}
                      </td>
                      <td className="hidden lg:table-cell px-4 py-4 text-center font-semibold text-gray-500 tabular-nums text-sm whitespace-nowrap">
                        {team.homeRecord}
                      </td>
                      <td className="hidden lg:table-cell px-4 py-4 text-center font-semibold text-gray-500 tabular-nums text-sm whitespace-nowrap">
                        {team.awayRecord}
                      </td>
                      <td className="hidden md:table-cell px-4 py-4 text-center font-bold text-gray-600 tabular-nums text-sm whitespace-nowrap">
                        {team.last10}
                      </td>
